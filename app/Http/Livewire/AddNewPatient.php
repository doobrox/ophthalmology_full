...
class AddNewPatient extends ModalComponent
{
    ...
    public function store()
    {
        ...
        Patient::create([
            ...
            'patient_name_and_forename' => $this->patient_name . ' ' . $this->patient_forename,
            'patient_age' => $this->patient_age,
        ]);

        $this->resetInputFields();

        session()->flash('message', 'Pacient adaugat cu success!');
    ...
    {
        return view('livewire.add-new-patient');
    }
}
