...
//        ['header' => 'account_settings'],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Date Facturare',
                    'url'  => 'pages/date_facturare.html',
                    'icon' => 'nav-icon fas fa-info',
                ],
                [
                    'text' => 'Date Firme',
                    'url'  => 'pages/date_firma.html',
                    'icon' => 'nav-icon fas fa-building',
                ],
                [
                    'text' => 'Utilizatori',
                    'url'  => 'pages/utilizatori.html',
                    'icon' => 'nav-icon far fa-address-card',
                ],
                [
                    'text' => 'Grupuri',
                    'url'  => 'pages/grupuri.html',
                    'icon' => 'nav-icon far fa-address-card',
                ],
                [
                    'text' => 'Personalizare',
                    'url'  => 'pages/personalizare.html',
                    'icon' => 'nav-icon fas fa-cogs',
                ],
                [
                    'text' => 'Setari Cont',
                    'url'  => 'pages/setari_cont.html',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Plan Tarifar',
                    'url'  => 'pages/planuri_tarifare.html',
                    'icon' => 'nav-icon fas fa-cogs',
                ],
            ],
        ],
        ...
        [
            'text' => 'Asistenta',
            'url'  => 'pages/asistenta.html',
            'icon' => 'nav-icon fas fa-user-nurse',
            'active' => ['asistenta'],
        ],
        [
            'text' => 'Medic',
