...
class Column
{
    ...
    public function linkEmitModal($whatModal, $slot = null, $paramsModal = null)
    {
        $this->callback = function ($caption, $row) use ($whatModal, $slot, $paramsModal) {
            $substitutes = ['{{caption}}' => $caption];
            ...
            return view('datatables::linkEmitModal', [
                'whatModal' => strtr($whatModal, $substitutes),
                'paramsModal' => strtr($paramsModal, $substitutes),
                'slot' => strtr($slot, $substitutes),
            ]);
        };
