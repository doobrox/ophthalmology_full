<div x-data class="flex flex-col">
    <input
        x-ref="input"
        type="text"
        class="min-h-25px m-1 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
