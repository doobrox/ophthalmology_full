    ...
    <form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="grid grid-cols-6 gap-6">
            <div class="col-span-2 {{ $errors->has('user.name') ? 'invalid' : '' }}">
                ...
                <input class="form-control form-control-sm" type="text" name="name" id="name" required wire:model.defer="user.name">
            ...
            <div class="col-span-2 {{ $errors->has('user.email') ? 'invalid' : '' }}">
                ...
                <input class="form-control form-control-sm" type="email" name="email" id="email" required wire:model.defer="user.email">
                <div class="validation-message">
